...
const siteConfiguration = fs.existsSync(figmaSiteJsonPath)
...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? 'Cyber Sathi'
  const description = config.description ?? 'Cyber Sathi helps users report scams, track complaints, and get support through guided steps.'
